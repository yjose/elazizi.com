...
banner: ./images/react-native-libraries.png
---
...
The advantage to using `react-native-image-crop-picker` is that, unlike `react-native-image-picker`, it enables you to crop and compress images. This is especially critical when building iOS apps because uploading large files could introduce performance issues. Compressing and cropping images is also helpful for users with low internet speed.
...
The Android configuraiton for `react-native-image-crop-picker` is as follows.
